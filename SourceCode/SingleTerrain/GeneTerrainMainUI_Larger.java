...
public class GeneTerrainMainUI_Larger extends GeneTerrainMainUI{
	...
	{
		GeneTerrainMainUI_Larger testUI = new GeneTerrainMainUI_Larger();
	}

	/**
	 * Create the application.
	 */
	public GeneTerrainMainUI_Larger() 
	{
		initialize();
	...
	private void initialize() 
	{
		...
		this.setBounds(100, 100, 1639, 1071);
		...
		terrainPanel.setBounds(601, 11, 1024, 1024);
		terrainPanel.setSize(1024, 1024);
		...
		createTerrainBtn.setBounds(191, 86, 141, 23);
