...
public class GeneTerrainMainUI extends JFrame{
	...
	MouseEventListener mouseEventHandler;
	...
	JLabel maskFileLbl; // notice the user about the mask file name
	...
	JButton chooseMaskFileBtn; //choose mask file button
	JButton choseEdgeFileBtn; // choose edge file button
	JButton choseNodeFileBtn; // choose node file button
	JButton chooseLayoutFileBtn; // choose layout file button
	...
	{
		GeneTerrainMainUI testUI = new GeneTerrainMainUI();
	}
	...
	public GeneTerrainMainUI() 
	{
		...
		mouseEventHandler = new MouseEventListener(terrainData, terrainPanel);
		terrainPanel.addMouseListener(mouseEventHandler);
		xmlWriter = new Terrain2XML(this);
	}
	...
	private void initialize() 
	{
		...
		terrainPanel = new DrawingTerrainPanel(this);
		...
		choseNodeFileBtn = new JButton("Choose node file");
		...
		choseEdgeFileBtn = new JButton("Choose edge file");
		...
		chooseLayoutFileBtn = new JButton("Choose layout file");
		...
		chooseMaskFileBtn = new JButton("Choose mask file");
		chooseMaskFileBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				eventHandler.choseMaskFileEvent();
			}
		});
		...
		maskFileLbl = new JLabel("(not uploaded)"); // display the mask file name
		maskFileLbl.setBounds(191, 117, 147, 19);
		getContentPane().add(maskFileLbl);
		maskFileLbl.setVisible(true);
		...
		colorBarPanel = new ColorBarPanel();
		...
		/// ------------ load terrain -------------------
		JButton loadTerrainBtn = new JButton("Load terrain");
		loadTerrainBtn.setBounds(10, 540, 126, 23);
		getContentPane().add(loadTerrainBtn);
		loadTerrainBtn.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent arg0) {
				eventHandler.loadTerrainEvent();
			}
		});
