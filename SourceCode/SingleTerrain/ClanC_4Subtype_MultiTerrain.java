...
public class ClanC_4Subtype_MultiTerrain 
{
	final int NUM_GENE = 3;
	final int NUM_CLASSICAL_SAMPLE = 41;
	final int NUM_MESENCHYMAL_SAMPLE = 20;

	final int NUM_NEURAL_SAMPLE = 26;
	final int NUM_PRONEURAL_SAMPLE = 31;

	GeneTerrainMainUI testUI ;

	NumberFormat usFormat;

	public ClanC_4Subtype_MultiTerrain()
	{
	...
	private void createClassicalProfileTerrain()
	{
		try
		{
			testUI.geneListFile = new File ("/home/thanhnguyen/Desktop/OtherGBMSet/ClanC/"
					+ "TerrainData/Classical/profileExpression.txt");
			testUI.connectionFile = null;
			testUI.layoutFile = new File("/home/thanhnguyen/Desktop/OtherGBMSet/ClanC/TerrainData/Layout_equalWeight.txt");
			...
			testUI.terrainPanel.saveImage("/home/thanhnguyen/Desktop/OtherGBMSet/ClanC/"
	...
	public static void main(String [] arg)
	{
		...
		new ClanC_4Subtype_MultiTerrain();
