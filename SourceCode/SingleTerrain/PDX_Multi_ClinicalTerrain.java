...
public class PDX_Multi_ClinicalTerrain 
{
	...
	public PDX_Multi_ClinicalTerrain()
	{
	...
	private void getFileList()
	{
		try
		{
			Scanner expressionMeta = new Scanner (new File("/home/thanhnguyen/RWorkspace/gbm_mayo_pdx_sarkaria_2019/"
					+ "clinicalProfileTerrain/Metadata.txt"));
	...
	private void createAllTerrain()
	{
		try
		{
			for (int i = 0; i < fileList.length; i++)
			{
				testUI.geneListFile = new File ("/home/thanhnguyen/RWorkspace/gbm_mayo_pdx_sarkaria_2019/"
						+ "clinicalProfileTerrain/expressionFile/" + fileList[i] + ".txt");
				testUI.connectionFile = null;
				testUI.layoutFile = new File("/home/thanhnguyen/RWorkspace/gbm_mayo_pdx_sarkaria_2019/"
						+ "clinicalProfileTerrain/Layout_equalWeight.txt");
				...
				testUI.terrainPanel.saveImage("/home/thanhnguyen/RWorkspace/gbm_mayo_pdx_sarkaria_2019/"
						+ "clinicalProfileTerrain/terrainImage/" + fileList[i] + ".png");
			}
